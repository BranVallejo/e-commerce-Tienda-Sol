...
export default function ProductDetailCart({
  ...
  const botonClases = agregado
    ? "bg-green-600 text-white shadow-lg shadow-green-500/40 dark:shadow-green-500/30"
    : botonDisabled
    ? "bg-gray-300 text-gray-500 dark:bg-neutral-700 dark:text-neutral-400 cursor-not-allowed"
    : "bg-indigo-600 hover:bg-indigo-700 text-white shadow-md shadow-indigo-500/40 dark:bg-indigo-500 dark:hover:bg-indigo-600";
      ...
      <div className="flex items-center justify-center sm:justify-start">
        <div
          className="flex items-center rounded-2xl border border-neutral-300 dark:border-neutral-600 
                     bg-neutral-100 dark:bg-neutral-700 overflow-hidden shadow-sm"
        >
          <button
